...
# 400-600
rsync -av $( find ${pathFromZeno}/*.gz | sort | head -n 600 | tail -n 200 )  ${TMPDIR}/work
...
do
        ./CLARK -T ${TMPDIR}/soft/clark_virulence_db/targets_finished.txt -D ${TMPDIR}/soft/clark_virulence_db/db_files -P ${TMPDIR}/work/${file}pairs_R1.fastq ${TMPDIR}/work/${file}pairs_R2.fastq -R ${TMPDIR}/out/${file}clarkOut -m 0 -n 16 --ldm -k 21
done
...
rsync -av ${TMPDIR}/out/* ${pathToZeno}/CLARK_out/virulence
